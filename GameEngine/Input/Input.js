define(["require", "exports"], function (require, exports) {
    ...
    class Input {
         ...
         */
        static update() {
            let n = Input.framePressedKeys.pop();
    ...
    Input.totalKeyCodes = 222;
    Input.keyDown = new Array(Input.totalKeyCodes);
    Input.keyPressed = new Array(Input.totalKeyCodes);
    Input.keyUp = new Array(Input.totalKeyCodes);
    Input.framePressedKeys = [];
    exports.Input = Input;
});
